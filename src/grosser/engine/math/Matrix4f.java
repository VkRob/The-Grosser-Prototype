...
public class Matrix4f {
	...
	/**
	 * Returns a new Float Buffer with the matrix data
	 *
	 * 
	 */
	...
	public static Matrix4f translate(Vector3f vec) {
		...
		translation.m03 = vec.x;
		translation.m13 = vec.y;
		translation.m23 = vec.z;
	...
	public static Matrix4f rotate(float angle, Vector3f coordinates) {
		return Matrix4f.rotate(angle, coordinates.x, coordinates.y, coordinates.z);
	}
	...
	public static Matrix4f lookAt(Vector3f eye, Vector3f center, Vector3f up) {
		...
		return result.multiply(translate(new Vector3f(-eye.x, -eye.y, -eye.z)));
	}
