...
public class Tile {
	...
	public Tile(Vector2f tilePosition, int ID, Render render) {
		...
		lightColor.add(new Vector3f(0.0f, 0.0f, 0.0f));
		lightPosition.add(new Vector3f(5.0f, -5.0f, 1f));
		//
		lightColor.add(new Vector3f(1f, 1f, 1f));
		lightPosition.add(new Vector3f(7.0f, 0.0f, 1f));
	...
	public void renderNormally(ArrayList<Tile> in) {
		...
		Comparator<Vector2f> distanceSorter = new DistanceSorter(
				new Vector2f(lightPosition.get(1).x, lightPosition.get(1).y));
		...
		Comparator<Vector2f> clockwiseSorter = new ClockwiseSorter(
				new Vector2f(lightPosition.get(1).x, lightPosition.get(1).y));
		// Collections.sort(send, clockwiseSorter);
